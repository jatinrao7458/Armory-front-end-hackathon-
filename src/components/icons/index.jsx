export const ArrowPath = ({ className = "w-6 h-6", ...props }) => (
...
export const ArrowTrendingUp = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className} {...props}>
...
export const ChartPie = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className} {...props}>
...
export const ChevronLeft = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className} {...props}>
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m15.75 19.5l-7.5-7.5l7.5-7.5"/>
  </svg>
);

export const ChevronRight = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className} {...props}>
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m8.25 4.5l7.5 7.5l-7.5 7.5"/>
  </svg>
);

export const ChevronUp = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className} {...props}>
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m4.5 15.75l7.5-7.5l7.5 7.5"/>
  </svg>
);

export const ChevronUpSolid = ({ className = "w-6 h-6", ...props }) => (
...
export const Cog8Tooth = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className} {...props}>
    <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export const Cube16Solid = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className={className} {...props}>
...
export const LinkSolid = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} {...props}>
...
export const XMark = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className} {...props}>
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M6 18L18 6M6 6l12 12"/>
  </svg>
);

// Section label icon (wavy lines pattern from demo)
export const WavyLines = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className} {...props}>
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M2 8c2-2 4-2 6 0s4 2 6 0s4-2 6 0"/>
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M2 12c2-2 4-2 6 0s4 2 6 0s4-2 6 0"/>
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M2 16c2-2 4-2 6 0s4 2 6 0s4-2 6 0"/>
  </svg>
);

// Bolt/Lightning logo icon (from demo's Armory logo)
export const BoltLogo = ({ className = "w-8 h-8", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} {...props}>
